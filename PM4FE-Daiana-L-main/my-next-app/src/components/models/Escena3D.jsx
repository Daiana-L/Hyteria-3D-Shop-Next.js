...
export default function Escena3D() {
    return (
        <div className="flex items-center justify-center lg:w-[42vh] xs:w-[35vh] xs:h-[40vh] lg:bg-indigo-600/95 xs:hidden-bg-indigo-600/95 lg:rounded-xl xs:rounded-lg backdrop-blur-md xs:ml-4 ">
