...
export default function Page() {
    return (
        <div>
            <div className="py-10 lg:py-20 xs:p-6 xs:py-6 overflow-x-hidden">
                        ...
                        >
                            ...
                            <div className="flex gap-4 xs:gap-1 flex-col">
                                ...
                                <p className="lg:text-xl xs:text-base leading-relaxed tracking-tight text-muted-foreground max-w-md text-left">
                                    En Hysteria_3D somos un pequeño
                                    emprendimiento que te ofrece compras online
                                    fáciles y rápidas. Olvidate de
                                    complicaciones: acá podés elegir y encargar
                                    tus impresiones 3D de forma simple, desde
                                    donde estés!
                                </p>
                            </div>
