...
export default function Cart() {
    ...
    return (
        <section className="lg:py-6 xs:py-2 lg:w-[120vh] lg:h-[70vh]" data-aos="fade-down">
            <div className="bg-white lg:p-8 xs:p-4 rounded-3xl shadow-xl">
                ...
                <div className="grid xs:grid-cols-1 lg:grid-cols-2 xs:gap-3 lg:gap-10">
                    <div className="lg:space-y-6 xs:space-y-3">
                        <h2 className="lg:text-xl font-semibold text-gray-800 lg:mb-10 ml-3">
                            ...
                            cart.map(
                                (product: Partial<Product>, index: number) => (
                                    <div
                                        ...
                                        className="flex items-center justify-between lg:p-4 xs:p-2 bg-gray-100 rounded-xl shadow-sm hover:shadow-md transition"
                                    >
                    ...
                    <div>
                        <h2 className="lg:text-xl font-semibold text-gray-800 lg:mb-10 xs:mb-5 ml-3">
                            Resumen del pedido
                        </h2>

                        <div className="lg:p-8 xs:p-3 bg-indigo-50 rounded-2xl shadow-lg flex flex-col">
                            <div className="flex flex-col gap-1">
                                ...
                                <div>
                                    <p className="text-gray-800 font-medium lg:mb-2">
                                        Métodos de envío
                                    </p>
                                    <Image
                                        src={CardImage2}
                                        ...
                                        width={110}
                                        className="rounded-xl xs:mb-2 lg:mb-4"
                                    />
                                </div>
                            </div>

                            <p className="lg:text-xl text-gray-800 font-semibold">
                                Total:{" "}
